...
exports.connectRedisQueue = exports.connectRedis = exports.redisQueueClient = exports.redisClient = void 0;
...
var connectRedisQueue = function () { return __awaiter(void 0, void 0, void 0, function () {
    var error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, exports.redisQueueClient.connect()];
            case 1:
                _a.sent();
