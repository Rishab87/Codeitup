...
const Page = ({params}:{params:{questionId:string}}) => {
  ...
  return (
    <div className='w-[100vw]'>
      ...
      >
        <ResizablePanel defaultSize={40} className='h-[80vh] w-full'>
        <Tabs defaultValue="Questions" className="w-[150px] p-2">
            ...
            <TabsContent value="Submisions">Coming Soon</TabsContent>
