          ...
          <div className="grid w-full items-center gap-4">
            ...
            <div className="flex gap-3">
                <div className="flex flex-col space-y-1.5">
                    ...
                    <Input id="lastName" type="text" placeholder="Last Name" aria-required {...register("username" , {required:true})}/>
                    {
                        errors.lastName && <span className="text-red-500">Username is required</span>
                    }
                </div>
            </div>
            <div className="flex flex-col space-y-1.5">
